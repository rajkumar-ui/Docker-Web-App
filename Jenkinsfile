      ...
      stage('Run Docker Image In Dev Server'){
        ...
        def dockerRun = ' docker run  -d -p 8080:8080 --name java-web-app goldentech/java-web-app'
         ...
         sshagent(['DOCKER_SERVER']) {
          ...
          sh 'ssh  ubuntu@172.31.32.75 docker rm java-web-app || true'
          sh 'ssh  ubuntu@172.31.32.75 docker rmi -f  $(docker images -q) || true'
          sh "ssh  ubuntu@172.31.32.75 ${dockerRun}"
       }
